...
class Htar:
    ...
    @classmethod
    def create(cls, tarball: str, fileset: list, flags: str = "") -> None:
    ...
    @classmethod
    def cvf(cls, tarball: str, fileset: list) -> None:
        ...
        fileset : list
                List containing filenames, patterns, or directories to archive
        """
        cls.create(tarball, fileset, flags = "-v")


    @classmethod
    def extract(cls, tarball: str, fileset: list = [], flags: str = "") -> None:
    ...
    @classmethod
    def xvf(cls, tarball: str = "", fileset: list = []) -> None:
        ...
        fileset : list
                ...
                the archive.  If empty, then all files will be extracted.
        """
        cls.extract(tarball, fileset, flags = "-v")


    @classmethod
    def tell(cls, tarball: str, flags: str = "", fileset: list = []) -> None:
