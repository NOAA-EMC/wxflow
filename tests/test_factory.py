...
def test_factory():
    ...
    # linter will likely throw an error here since 'Test0Factory' is not a valid module until runtime
        ...
        raise AssertionError(
            "'Test0Factory' was not found in the 'wxflow.factory' module"
        )
...
def test_create():
    ...
    assert (
        c1.my_name == "Class1"
    ), "Error in creating builder 'Class1' in Factory 'Test2Factory'"
    c2 = factory.create("Class2")
    assert (
        c2.my_name == "Class2"
    ), "Error in creating builder 'Class2' in Factory 'Test2Factory'"
...
def test_registered():
    ...
    assert factory.registered == {
        "Class1",
        "Class2",
    }, "Unregistered builders in 'Test4Factory'"
...
def test_is_registered():
    ...
    assert not (
        factory.is_registered("Class3")
    ), "Unregistered builder in 'Test5Factory'"
